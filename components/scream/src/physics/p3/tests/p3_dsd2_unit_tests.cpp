...
struct UnitWrap::UnitTest<D>::TestDsd2 {
  ...
  static void run_cloud_bfb()
  {
    ...
    GetCloudDsd2Data gcdd[max_pack_size] = {
      {0.998086E-06, 0.114746E+01, 0.100000E+01, 0, 0, 0, 0, 0, 0},
      {0.292481E-07, 0.758028E+00, 0.100000E+01, 0, 0, 0, 0, 0, 0},
      {0.510000E-02, 0.970269E+00, 0.100000E+01, 0, 0, 0, 0, 0, 0},
      {0.510000E-02, 0.980946E+00, 0.100000E+01, 0, 0, 0, 0, 0, 0},

      {0.998086E-06, 0.114746E+01, 0.100000E+01, 0, 0, 0, 0, 0, 0},
      {0.0,          0.758028E+00, 0.100000E+01, 0, 0, 0, 0, 0, 0},
      {0.510000E-02, 0.970269E+00, 0.100000E+01, 0, 0, 0, 0, 0, 0},
      {0.0,          0.980946E+00, 0.100000E+01, 0, 0, 0, 0, 0, 0},

      {0.000000E+00, 1.144941E+00, 1.000000E+00, 0, 0, 0, 0, 0, 0},
      {0.292481E-07, 0.758028E+00, 0.100000E+01, 0, 0, 0, 0, 0, 0},
      {0.510000E-02, 0.970269E+00, 0.100000E+01, 0, 0, 0, 0, 0, 0},
      {0.510000E-02, 0.980946E+00, 0.100000E+01, 0, 0, 0, 0, 0, 0},
  ...
  static void run_rain_bfb()
  {
    ...
    GetRainDsd2Data grdd[max_pack_size] = {
      {0.100000E-01, 0.100000E+01, 0, 0, 0, 0, 0},
      {0.100000E-01, 0.100000E+01, 0, 0, 0, 0, 0},
      {0.156316E-03, 0.100000E+01, 0, 0, 0, 0, 0},
      {0.148647E-03, 0.100000E+01, 0, 0, 0, 0, 0},

      {0.100000E-01, 0.100000E+01, 0, 0, 0, 0, 0},
      {0.0,          0.100000E+01, 0, 0, 0, 0, 0},
      {0.156316E-03, 0.100000E+01, 0, 0, 0, 0, 0},
      {0.0,          0.100000E+01, 0, 0, 0, 0, 0},
