...
RES=ne30pg2_ne30pg2         #or whatever resolution you want
CASE_NAME=${COMPSET}-${RES}-new-settings-${nnodes}nodes  #name for your simulation.
...
./atmchange pgrad_correction=1
./atmchange hv_ref_profiles=6
